...
//NormalMember mem1 = new NormalMember("Special Rate", "Jaimito", 2, 2011);
//VIPMember mem2 = new VIPMember("Andres", 2, 2011);
...
Member[] clubMembers = new Member[5];//declare an array of MEMBER TYPE
clubMembers[0] = new NormalMember("Special Rate", "James", 1, 2010);
clubMembers[1] = new NormalMember("Normal Rate", "Andres", 2, 2011);
clubMembers[2] = new NormalMember("Normal Rate", "Bill", 3, 2011);
clubMembers[3] = new VIPMember("Carol", 4, 2012);
clubMembers[4] = new VIPMember("Eva", 5, 2012);
...
{
    public NormalMember() //one way to declare child constructor
    {
        Console.WriteLine("Child constructor with no parameter");
    }

    public NormalMember(string remarks, string name, int memberID, int memberSince) : base(name, memberID, memberSince) //second way to declare a child constructor
    {
